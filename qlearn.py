...
def seleccionar_accion(Q, estado, epsilon):
    ...
    epsilon (float): Tasa de exploración.
...
def obtener_recompensa(estado, accion, mapa, salida):
    """
    Define la recompensa basada en el estado y acción.
...
def entrenar_Q_learning(maze, Q, salida, alpha=0.1, gamma=0.9, epsilon=1.0, min_epsilon=0.1, decay_rate=0.995, episodes=1000):
    """
    Entrena la tabla Q utilizando el algoritmo Q-learning.
    ...
    min_epsilon (float): Tasa de exploración mínima.
    decay_rate (float): Tasa de decaimiento de epsilon.
...
# Funciones de movimiento que deben estar disponibles en qlearn.py
# Puedes mover estas funciones aquí o importarlas si aún están en main.py
